...
public class Goods : ScriptableObject
{
	...
	[SerializeField]
	protected float basePrice;					// basePrice is the lowest price that a Good can be traded for. It is a reflection of 
	...
	public int Tyranny {get; set;}				// Determines how much the government's Tyranny increases when the player sells this Good to the
												// government.
}